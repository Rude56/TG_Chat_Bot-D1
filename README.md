...
3. 点击 **编辑代码**
4. **全量覆盖**：删除所有默认代码，将 [`TG_Chat_Bot-D1.js`](https://github.com/Rude56/TG_Chat_Bot-D1/blob/main/TG_Chat_Bot-D1.js) 的完整代码粘贴进去
5. **点击部署**，进行下一步配置
...
| `TELEGRAM_WEBHOOK_SECRET` | `mRD0p7...` | 自定义随机字符 A-Z、a-z、0-9、_（下划线）、-（连字符） |
